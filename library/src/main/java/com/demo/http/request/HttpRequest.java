...
import com.demo.http.EasyHttp;
import com.demo.http.EasyLog;
import com.demo.http.EasyUtils;
import com.demo.http.annotation.HttpHeader;
import com.demo.http.annotation.HttpIgnore;
import com.demo.http.annotation.HttpRename;
import com.demo.http.callback.NormalCallback;
import com.demo.http.config.IRequestApi;
import com.demo.http.config.IRequestCache;
import com.demo.http.config.IRequestClient;
import com.demo.http.config.IRequestHandler;
import com.demo.http.config.IRequestHost;
import com.demo.http.config.IRequestInterceptor;
import com.demo.http.config.IRequestServer;
import com.demo.http.config.IRequestType;
import com.demo.http.config.RequestApi;
import com.demo.http.config.RequestServer;
import com.demo.http.lifecycle.HttpLifecycleManager;
import com.demo.http.listener.OnHttpListener;
import com.demo.http.model.BodyType;
import com.demo.http.model.CacheMode;
import com.demo.http.model.CallProxy;
import com.demo.http.model.HttpHeaders;
import com.demo.http.model.HttpParams;
import com.demo.http.model.ResponseClass;
