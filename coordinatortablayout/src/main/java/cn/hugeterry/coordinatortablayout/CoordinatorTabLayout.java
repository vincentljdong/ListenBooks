...
public class CoordinatorTabLayout extends CoordinatorLayout {
     ...
     * @return CoordinatorTabLayout
     */
    public CoordinatorTabLayout setImageArray(@NonNull String[] imageArray) {
     ...
     * @return CoordinatorTabLayout
     */
    public CoordinatorTabLayout setImageArray(@NonNull String[] imageArray, @NonNull int[] colorArray) {
        mImageArray = imageArray;
        ...
        mTabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if (mLoadHeaderImagesListener == null) {
                    Log.d("网络图片：", "mLoadHeaderImagesListener == null");
                    if (mImageArray != null) {
                        Log.d("网络图片：", mImageArray[tab.getPosition()]);
//                        mImageView.setImageResource(mImageArray[tab.getPosition()]);
                        Glide.with(mContext)
                                .load(mImageArray[tab.getPosition()])
                                .into(mImageView);
                    }
                } else {
                    Log.d("网络图片：", "mLoadHeaderImagesListener != null");
